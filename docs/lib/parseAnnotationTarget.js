 ...
 */
function parseNonNegativeValue(str) {
 ...
 */
function parseTemporalFromFragment(fragment) {
 ...
 */
function parseSpatialFromFragment(fragment) {
 ...
 */
export function parseMediaFragment(uri) {
 ...
 */
function parseSpecificResourceTarget(target) {
 ...
 * ```
 */
export function parseAnnotationTarget(target) {
	if (!target) {
		return null;
	}
...
//# sourceMappingURL=parseAnnotationTarget.js.map
